...
하지만, 개발할 때 확인하지 못했던 예외사항을 테스트를 통해 깨닫게 되거나, 기존에 개발했던 코드를 수정해야 할 경우에도 기존에 작성한 테스트 코드를 통해 연관된 기능의 정상 여부를 확인하고 수정할 수 있었습니다. 이러한 과정을 통해 더 안정적인 애플리케이션을 개발할 수 있었다고 생각하며, 테스트의 중요성에 대해 몸소 느낄 수 있었습니다.
